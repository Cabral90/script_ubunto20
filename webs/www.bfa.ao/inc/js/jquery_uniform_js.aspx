...
<meta property="og:url" content="http://localhost/inc/js/jquery_uniform_js.aspx" />
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=0">
<link rel="stylesheet" href="/css/bfa-app-c0d80d7ee5.min.css">
...
<body class="" data-lang="en" data-id="2223" data-homepage-id="1581" data-page-type="detail"
      ...
      data-key="AIzaSyA2WiEZMJcDl4sexkFGbP0J5hSKYCUl3i0">
...
<ul class="menu-lang-list js-menuLang">
        ...
        <ul class="nav">
                    ...
                    <li data-id="5">
                        <span class="menu-item js-menu-item " data-action="openChilds" data-id="5">
                            <span class="text">Work for BFA</span>
                            <span class="icon icon-arrow-right"></span>
                        </span>
                    </li>
                    <li data-id="6">
    ...
    <div class="panel js-mobilePanel " data-parent-id="1">
        <ul class="nav">
                    ...
                    <li> <a class="menu-item js-menu-item " href="/en/bfa/meet-bfa/executive-committee-biographies/" data-id="15" target="_self"><span class="text">Executive Committee Biographies</span></a></li>
                    ...
                    <li> <a class="menu-item js-menu-item " href="/en/bfa/meet-bfa/bfa-25-years/" data-id="17" target="_self"><span class="text">BFA 25 Years</span></a></li>
                    <li> <a class="menu-item js-menu-item " href="/en/bfa/meet-bfa/bfa-2-million-custumers/" data-id="18" target="_self"><span class="text">BFA 2 Million Customers</span></a></li>
        </ul>
    </div>
    <!-- GO -->
    ...
    <div class="panel js-mobilePanel " data-parent-id="3">
        <ul class="nav">
                    <li> <a class="menu-item js-menu-item " href="/en/bfa/social-responsibility/bfa-solidarity-program-2021/" data-id="31" target="_self"><span class="text">BFA Solidarity Program 2021</span></a></li>
                    <li> <a class="menu-item js-menu-item " href="/en/bfa/social-responsibility/bfa-social-fund/" data-id="32" target="_self"><span class="text">BFA Social Fund</span></a></li>
                    <li> <a class="menu-item js-menu-item " href="/en/bfa/social-responsibility/projects/" data-id="33" target="_self"><span class="text">Projects</span></a></li>
                    <li> <a class="menu-item js-menu-item " href="/en/bfa/social-responsibility/official-sponsor-of-angolan-happiness/" data-id="34" target="_self"><span class="text">BFA Sponsor of Happiness</span></a></li>
                    <li> <a class="menu-item js-menu-item " href="/en/bfa/social-responsibility/official-sponsor-of-angolan-passion/" data-id="35" target="_self"><span class="text">BFA Sponsor of Passion</span></a></li>
                    <li> <a class="menu-item js-menu-item " href="/en/bfa/social-responsibility/official-sponsor-of-angolan-ambition/" data-id="36" target="_self"><span class="text">BFA Sponsor of Ambition</span></a></li>
        </ul>
    </div>
    <!-- GO -->
    <div class="panel js-mobilePanel " data-parent-id="5">
        <ul class="nav">
                    <li> <a class="menu-item js-menu-item " href="/en/bfa/work-for-bfa/recruitment/" data-id="51" target="_self"><span class="text">recruitment</span></a></li>
                    <li> <a class="menu-item js-menu-item " href="/en/bfa/work-for-bfa/spontaneous-application/" data-id="52" target="_self"><span class="text">Spontaneous Application</span></a></li>
        </ul>
    </div>
    <!-- GO -->
    <div class="panel js-mobilePanel " data-parent-id="6">
        <ul class="nav">
                    <li> <a class="menu-item js-menu-item " href="/en/bfa/press-center/news/" data-id="61" target="_self"><span class="text">News</span></a></li>
                    <li> <a class="menu-item js-menu-item " href="/en/bfa/press-center/research/" data-id="62" target="_self"><span class="text">Research</span></a></li>
                    <li> <a class="menu-item js-menu-item " href="/en/bfa/press-center/regulation/" data-id="63" target="_self"><span class="text">Regulation</span></a></li>
                    <li> <a class="menu-item js-menu-item " href="/en/bfa/press-center/bfa-tourism-web-site/" data-id="64" target="_self"><span class="text">BFA Tourism Web Site</span></a></li>
                    <li> <a class="menu-item js-menu-item " href="/en/bfa/press-center/treasury-bonds/" data-id="65" target="_self"><span class="text">Treasury Bonds</span></a></li>
                    <li> <a class="menu-item js-menu-item " href="/en/bfa/press-center/media-kit/" data-id="66" target="_self"><span class="text">Media Kit</span></a></li>
                    <li> <a class="menu-item js-menu-item " href="/en/bfa/bfa-channel/" data-id="67" target="_self"><span class="text">BFA Channel</span></a></li>
        </ul>
    </div>
    ...
    <h1>System.Collections.Generic.List`1[BFA.Core.Models.MenuMainTopModel]</h1>
            ...
            <!-- 15 » 11547 » Executive Committee Biographies -->
            <!-- 16 » 7738 » Financial Information -->
            <!-- 17 » 5474 » BFA 25 Years -->
            <!-- 18 » 5466 » BFA 2 Million Customers -->
            <!-- 21 » 5242 » Corporate Governance -->
            <!-- 22 » 5503 » Compliance -->
            <!-- 23 » 5509 » Policies -->
            <!-- 24 » 5521 » Deposit Garantee Fund -->
            <!-- 31 » 13213 » BFA Solidarity Program 2021 -->
            <!-- 32 » 5485 » BFA Social Fund -->
            <!-- 33 » 5496 » Projects -->
            <!-- 34 » 5545 » BFA Sponsor of Happiness -->
            <!-- 35 » 5549 » BFA Sponsor of Passion -->
            <!-- 36 » 5553 » BFA Sponsor of Ambition -->
            <!-- 51 » 1606 » recruitment -->
            <!-- 52 » 5709 » Spontaneous Application -->
            <!-- 61 » 5886 » News -->
            <!-- 62 » 5901 » Research -->
            <!-- 63 » 7504 » Regulation -->
            <!-- 64 » 5880 » BFA Tourism Web Site -->
    <!-- GO -->
            <!-- 65 » 13499 » Treasury Bonds -->
            <!-- 66 » 5924 » Media Kit -->
            <!-- 67 » 5249 » BFA Channel -->
...
<ul class="menu-lang-list js-menuLang">
    ...
    <div class="navigation-desktop js-desktop-navigation">
        ...
        <div class="container-fluid extend">
            ...
            <li data-id="5">
                <span class="menu-item js-menu-item " data-action="dropdown" data-id="5" ><span class="text">Work for BFA</span><span class="icon icon-arrow-right"></span></span>
            </li>
            <li data-id="6">
                <span class="menu-item js-menu-item " data-action="dropdown" data-id="6" data-preview-id=6><span class="text">Press Center</span><span class="icon icon-arrow-right"></span></span>
            </li>
        ...
        <div class="nav-children js-navChildren" data-parent-id="6">
            ...
            <li> <a class="menu-item js-menu-item " href="/en/bfa/press-center/research/" data-id="62"  target="_self"><span class="text">Research</span></a></li>
            <li> <a class="menu-item js-menu-item " href="/en/bfa/press-center/regulation/" data-id="63"  target="_self"><span class="text">Regulation</span></a></li>
            <li> <a class="menu-item js-menu-item " href="/en/bfa/press-center/bfa-tourism-web-site/" data-id="64" data-preview-id=64 target="_self"><span class="text">BFA Tourism Web Site</span></a></li>
            <li> <a class="menu-item js-menu-item " href="/en/bfa/press-center/treasury-bonds/" data-id="65" data-preview-id=65 target="_self"><span class="text">Treasury Bonds</span></a></li>
            <li> <a class="menu-item js-menu-item " href="/en/bfa/press-center/media-kit/" data-id="66" data-preview-id=66 target="_self"><span class="text">Media Kit</span></a></li>
            <li> <a class="menu-item js-menu-item " href="/en/bfa/bfa-channel/" data-id="67"  target="_self"><span class="text">BFA Channel</span></a></li>
        ...
        <ul class="site-map js-siteMap">
                    ...
                    <li>
                        ...
                        <ul>
                                ...
                                <li>
                                    <a href="/en/bfa/meet-bfa/bfa-25-years/">BFA 25 Years</a>
                                </li>
                                <li>
                                    <a href="/en/bfa/meet-bfa/bfa-2-million-custumers/">BFA 2 Million Custumers</a>
                                </li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <ul>
                                ...
                                <li>
                                    <a href="/en/bfa/social-responsibility/projects/">Projects</a>
                                </li>
                                <li>
                    ...
                    <li>
                        ...
                        <ul>
                                <li>
                                    <a href="/en/bfa/work-for-bfa/recruitment/">Recruitment</a>
                                </li>
                                <li>
                                    <a href="/en/bfa/work-for-bfa/spontaneous-application/">Spontaneous Application</a>
                                </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul>
                                ...
                                <li>
                                    <a href="/en/bfa/press-center/bfa-tourism-web-site/">BFA Tourism Web Site</a>
                                </li>
                                <li>
                                    <a href="/en/bfa/press-center/research/">Research</a>
                                </li>
                                <li>
                                    <a href="/en/bfa/press-center/regulation/">Regulation</a>
                                </li>
                                <li>
    ...
    <div class="container-fluid">
        ...
        <div class="footer-block">
            ...
            <div class="text">
                    ...
                    <p><a href="/en/bfa/perguntas-frequentes/">Common questions</a></p>
                    <p><a href="http://">Branch Network</a></p>
                    <p><a href="/en/bfa/work-for-bfa/">Work for BFA</a></p>
                    <p><a href="#">Suggestions and Complaint</a></p>
                    <p><a href="/en/bfa/pricing/pricing/">Pricing</a></p>
        ...
        <div class="footer-bottom js-footerBottom">
            <div class="container-fluid">
                <div class="copyright">
                    <p>Banco de Fomento Angola&#169;2019-2021. All rights reserved. <a href="/en/bfa/terms-and-conditions/">Terms and conditions</a></p>
                </div>
            </div>
        </div>
...
<script src="/libs/bfa-vendor-da4d535aad.min.js"></script>
<script src="/libs/bfa-custom-plugins-75041594f5.min.js"></script>
<script src="/scripts/bfa-app-ac50ad2a4b.min.js"></script>
